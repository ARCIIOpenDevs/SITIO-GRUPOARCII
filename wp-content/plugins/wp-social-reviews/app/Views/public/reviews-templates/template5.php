            ...
            >
                <?php
                    ...
                    do_action('wpsocialreviews/reviewer_image', $shouldShowIcon,
                        $reviewer_url, $review->reviewer_img, $review->reviewer_name, $enableExternalLink, $review->media_url, $review->platform_name, $template_meta['verified_badge_tooltip_text']);
                ?>
