...
class Enqueue {
	...
	public function frontend_scripts() {
		...
		// LightGallery CSS
		wp_register_style( 'igd-lightgallery', IGD_ASSETS . '/vendor/lightgallery/css/lightgallery-bundle.min.css', [], IGD_VERSION );
		...
		wp_enqueue_style( 'igd-dashicons', includes_url( 'css/dashicons.min.css' ), [], IGD_VERSION );
		...
		// Light Gallery JS
		wp_register_script( 'igd-lightgallery', IGD_ASSETS . '/vendor/lightgallery/lightgallery.min.js', [], IGD_VERSION, true );
	...
	public function admin_scripts( $hook = '', $should_check = true ) {
		...
		wp_enqueue_script( 'igd-admin', $igd_admin_src, array(
			"jquery",
			"wp-element",
			"wp-components",
			"wp-i18n",
		...
		if ( isset( $admin_pages['settings_page'] ) && $admin_pages['settings_page'] === $hook ) {
			...
			if ( igd_fs()->can_use_premium_code__premium_only() ) {
				// Google Picker API
				wp_enqueue_script( 'igd-google-drive-picker', IGD_ASSETS . '/vendor/google-picker-api.js', array(), IGD_VERSION, true );
			}
	...
	public function get_custom_css() {
        ...
        --color-primary-dark: <?php echo igd_color_brightness( $primary_color, - 30 ) ?>;
