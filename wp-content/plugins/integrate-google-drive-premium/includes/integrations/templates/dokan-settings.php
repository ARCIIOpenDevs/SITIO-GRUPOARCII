...
<div class="dokan-igd-settings">
    ...
    <div class="igd-dokan-settings-header">
        ...
        <a href="#" class="igd-btn btn-primary">
            <i class="dashicons dashicons-editor-help"></i>
            <span><?php echo __( "Documentation", "integrate-google-drive" ); ?></span>
        </a>
	...
	<?php if ( $is_dokan_upload ) { ?>
        ...
        <form class="dokan-form-horizontal" method="post" id="igd-dokan-upload-settings">
            ...
            <!-- Order Statues -->
            <div class="dokan-form-group">
                <label class="dokan-w3 dokan-control-label dokan-text-left" >
					<?php esc_html_e( 'Show Upload Box When Order Status is', 'integrate-google-drive' ); ?> </label>
