...
class Ajax {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_nopriv_igd_update_file_permission', [
			$this,
			'update_file_permission__premium_only'
		] );
	...
	public function handle_password_protected__premium_only() {

		// Check nonce
		$this->check_nonce( true );
	...
	public function handle_module_login() {
		...
		if ( empty( $username ) || empty( $password ) ) {
			wp_send_json_error( [ 'message' => __( 'Username and password are required.', 'integrate-google-drive' ) ] );
		}
	...
	public function get_access_token__premium_only() {
	...
	public function toggle_account_specific_folders__premium_only() {
	...
	public function remove_specific_folders__premium_only() {
	...
	public function save_specific_folders__premium_only() {
	...
	public function reset_current_usage() {
		...
		delete_metadata( 'user', null, 'igd_usage_limits', null, true );
	...
	public function update_file_permission__premium_only() {
		...
		// Check permission
		if ( ! Shortcode::can_do( 'update_file_permission' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action', 'integrate-google-drive' ) );
		}
