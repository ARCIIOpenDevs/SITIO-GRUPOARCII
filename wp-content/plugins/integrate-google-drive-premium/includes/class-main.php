...
final class Main {
	...
	public function includes() {
		...
		if ( igd_fs()->can_use_premium_code__premium_only() ) {
			...
			// Restrictions
			include_once IGD_INCLUDES . "/class-restrictions__premium_only.php";

			// Notifications
			include_once IGD_INCLUDES . "/class-notifications__premium_only.php";

			// Importer
			include_once IGD_INCLUDES . "/class-importer__premium_only.php";

			// Selections
			include_once IGD_INCLUDES . "/class-proof-selection__premium_only.php";
