...
if ( ! class_exists( 'LoginPress_Social_Utilities' ) ) {
	...
	class LoginPress_Social_Utilities {
		 ...
		 * @version 5.0.0
		 */
		public function _home_url( $user, $social_channel = '', $subscriber = '' ) {
			...
			if ( ! empty( $social_channel ) && is_array( $login_filter ) ) {
				switch ( $social_channel ) {
					...
					case 'apple_login':
						$social_redirect = $login_filter['apple_login'];
						break;
					...
					case 'microsoft_login':
						...
						break;
					case 'github_login':
						$social_redirect = $login_filter['github_login'];
						break;
					case 'discord_login':
						$social_redirect = $login_filter['discord_login'];
						break;
					case 'wordpress_login':
						$social_redirect = $login_filter['wordpress_login'];
						break;
					case 'amazon_login':
						$social_redirect = $login_filter['amazon_login'];
						break;
					case 'pinterest_login':
						$social_redirect = $login_filter['pinterest_login'];
						break;
					case 'disqus_login':
						$social_redirect = $login_filter['disqus_login'];
						break;
					case 'reddit_login':
						$social_redirect = $login_filter['reddit_login'];
						break;
					case 'twitch_login':
						$social_redirect = $login_filter['twitch_login'];
						break;
					case 'spotify_login':
						$social_redirect = $login_filter['spotify_login'];
						break;	
				}
		 ...
		 * @since 5.0.0.
		 */
		public static function loginpress_social_login_error( $user, $username, $password ) {
			$error = new WP_Error();
